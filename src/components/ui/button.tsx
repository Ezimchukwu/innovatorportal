  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border/80 bg-background/60 hover:bg-muted/60 hover:text-foreground shadow-sm",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 shadow-sm hover:shadow-md",
        ghost: "bg-transparent hover:bg-muted/60 hover:text-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        hero:
          "bg-[radial-gradient(circle_at_10%_0,hsla(46,96%,72%,0.85),hsla(259,72%,50%,0.95))] text-primary-foreground shadow-[var(--shadow-glow)] hover:brightness-110",
        subtle:
          "bg-card/70 text-foreground border border-border/70 hover:bg-card hover:shadow-md",
        pill:
          "bg-[var(--gradient-pill)] text-primary-foreground shadow-md hover:shadow-[var(--shadow-glow)]",
      },
      size: {
        default: "h-11 px-6",
        sm: "h-9 px-4 text-xs",
